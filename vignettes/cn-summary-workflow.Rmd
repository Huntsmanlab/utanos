...
Broadly, this vignette seeks to demonstrate how a user could answer the following two questions using __utanos__:
...
__Utanos__ provides two options by which to find answers to these questions. 1 - using plots/diagrams to visualize the differences, or 2 - by manually examining informative, well-formatted tables.
...
1 1           840001 1020000            0.150            0.301           0.0076          3
2 1          1020001 1950000            0.101            0.213           0.0076          3
3 1          1950001 2160000            0.146            0.213           0.0076          3
4 1          2160001 2220000            0.116            0.211           0.054           3
5 1          8880001 9060000            0.157            0.247           0.006           5
...
Here, we will briefly detail the options and workflow, but for a more thorough discussion we recommend the user read through the rascal vignette. 
...
There are three major options for scaling depending on the data available:
 ...
 2. __*maxvaf*__: In the case of having variant allele frequencies for each sample, these can be used to identify the nearest ploidy-cellularity combination (as described in 1.). This option will assume the maximum discovered VAF for the sample is an appropriate representation for the tumour fraction. Below is a equation describing the relationship used to select the optimal solution from the grid search. For more details see the vignette in the [rascal github repo](https://github.com/crukci-bioinformatics/rascal).
...
For each of these options, please consult the __utanos__ function documentation for specifics on expected formatting. 
