...
FindThreshold <- function(granges_obj, segments, num_simulations=100000, second_round, seed) {
  ### Set the seed for RNG; we have observed minor differences in the threshold returned between runs due to PRNG seeding
