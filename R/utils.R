...
# Converts result of DLP (segments.csv.gz) with bin and segment copynumber into a QDNAseq object
#' @importClassesFrom QDNAseq QDNAseqCopyNumbers
DlpToQDNAseq <- function(segment, genome = 'hg19') {
  df <- data.table::fread(segment)
