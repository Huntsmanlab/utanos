...
#'
#'
RunShallowHRD <- function(raw_ratios_file, log_transform=TRUE include_chr_X=FALSE, num_simulations,
  ...
  #### Levels ####
  prepped_gathered_by_ratio_median <- PrepForLevelsInitialization(segments=gathered_by_ratio_median)
